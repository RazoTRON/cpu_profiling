...
import org.hyperskill.cpuprofiling.internals.AbstractUnitTest
...
class Test {
    @Test fun testSolution() {
        ...
        Assert.assertTrue("Tests not implemented for the task", answer == "getProfileInfo")
    }
}
...
//        val expectedInitialText = answer
//        val actualInitialText = answer
